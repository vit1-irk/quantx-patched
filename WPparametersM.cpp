...
{
        this->setWindowTitle("Superposition of wavefunctions E_n<0");
        ...
        QVBoxLayout *vl = new QVBoxLayout(this);
    {
        ...
        this->leNmin->setToolTip("lower bond of the level number interval>=0");
    ...
    }
    {
        ...
        this->leNmax->setToolTip("upper bond of the level number interval<N");
        ...
        this->leHn->setToolTip("level number increment");
