...
: QDialog(parent,f), model(0)
{
...

    {
        ...
        h->addWidget(new QLabel("Umin",this));
        h->addWidget(this->leUmin= new QLineEdit(this));
        this->leUmin->setToolTip("Lower value of potential");
    ...
    }
    {
        QWidget *line = new QWidget(this);
        QHBoxLayout *h = new QHBoxLayout(line);
        h->addWidget(new QLabel("Umax",this));
        h->addWidget(this->leUmax= new QLineEdit(this));
        this->leUmax->setToolTip("High value of potential");
